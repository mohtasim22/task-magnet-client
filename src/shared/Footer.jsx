        ...
        <div className="">
            <div className="footer-section text-center py-8">
                <footer className="footer footer-center p-10 text-base-content rounded">
                    <nav className="grid grid-flow-row md:grid-flow-col gap-4 font-rajdhani font-bold text-xl list-none">
                        <Link to={"/"}><li><a>Home</a></li></Link>
                        <Link to={"/login"}><li><a>Create Tasks</a></li></Link>
                    ...
                    <aside className="font-rajdhani">
                        <p>Copyright © 2023 - All right reserved by Task-Magnet</p>
                    </aside>
                </footer>
            </div>
        </div>
